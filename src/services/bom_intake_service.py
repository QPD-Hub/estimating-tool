    ...
    def _build_metadata(self, header_data: Mapping[str, object]) -> BomIntakeMetadata:
        ...
        try:
            return BomIntakeMetadata(
                ...
                quoted_by=_optional_string(header_data, "quoted_by"),
                contact_name=_optional_string(header_data, "contact_name"),
                quote_due_date=_optional_string(header_data, "quote_due_date"),
